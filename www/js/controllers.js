...
.controller('AppController', function($scope, LoginService, $ionicPopup, $state, $ionicModal, $timeout) {
	//must be logged in to enter else see login.html
...
.controller('GameController', function($scope, $state, $ionicModal, $timeout, $ionicPopup, $timeout, $ionicLoading, ModalService, TeamService, PlayerService, CardService, DealerService, GameService) {
    ...
    var game = this;
	 ...
	 game.nextTurn= function() {
	   ...
	   $scope.showSuccess = function() {
	    ModalService
	      .init('templates/timer.html', $scope)
	      .then(function(modal) {
	        modal.show();
	      });
	  };
...
.controller('CardsController', ['$scope', '$window', '$interval', '$timeout', '$ionicModal', '$ionicLoading', '$http', 'TDCardDelegate', 'PlayerService', 'CardService', 'ModalService',
  function($scope, $window, $interval, $timeout, $ionicModal, $ionicLoading, $http, TDCardDelegate, PlayerService, CardService, ModalService) {
  ...
  //   CardService.setActiveCard(card);
  //   $scope.cardDestroyed();
  // };
  ...
  //   $("td-card").removeClass("showFlipInX");
  // 	//$("td-card").addClass("hiddenFlipInX");
  // 	//$("td-card").toggleClass("on");
  // };

  // $scope.onRelease = function(){
  //   console.log("... released me!");
  //   $("td-card").removeClass("without-shadow");
  //   $("td-card").addClass("showFlipInX");
