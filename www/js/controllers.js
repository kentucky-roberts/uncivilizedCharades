...
.controller('AppController', function($scope, LoginService, $ionicPopup, $state, $http, $ionicModal, $timeout) {
...
$scope.CountdownService = CountdownService;
    ...
    var toShowCountdown = CountdownService.tags.a;
    console.log(toShowCountdown);
	
	if (toShowCountdown == false) {
		$scope.newCountdown();
		$scope.selectTimer(2);
